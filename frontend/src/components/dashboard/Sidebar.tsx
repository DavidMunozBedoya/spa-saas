          ...
          <div className={cn(
            ...
            {!isCollapsed && (
              <div className="flex items-center justify-between">
                <p className="text-[10px] uppercase font-bold text-muted-foreground-auto tracking-widest">Contacto</p>
                <div className="flex items-center gap-2">
                  {spaConfig.facebook_url && (
                    <a href={spaConfig.facebook_url} target="_blank" rel="noopener noreferrer" className="text-foreground/40 hover:text-blue-500 transition-colors" title="Facebook">
                      <Facebook size={16} />
                    </a>
                  )}
                  {spaConfig.instagram_url && (
                    <a href={spaConfig.instagram_url} target="_blank" rel="noopener noreferrer" className="text-foreground/40 hover:text-pink-500 transition-colors" title="Instagram">
                      <Instagram size={16} />
                    </a>
                  )}
                </div>
            ...
            {spaConfig.phone && (
              <div className={cn("flex items-center", isCollapsed ? "justify-center pt-2 border-t border-foreground/5" : "justify-between")}>
                {!isCollapsed && (
                  <div className="flex items-center gap-2 text-foreground/60 text-xs font-medium overflow-hidden">
