...
export default function AppointmentsPage() {
  ...
  const hasViewPermission = userPermissions.includes("appointments:view") || userPermissions.includes("platform:manage");
  const hasCreatePermission = userPermissions.includes("appointments:create") || userPermissions.includes("platform:manage");
  const hasEditPermission = userPermissions.includes("appointments:edit") || userPermissions.includes("platform:manage");
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground-auto mt-1 font-medium">
            Gestiona las reservas y el tiempo de tus servicios de forma eficiente.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-3 space-y-6">
            <div className="glass rounded-3xl p-6 border border-foreground/10 sticky top-6 shadow-2xl shadow-black/5">
                <h3 className="text-xs font-black text-foreground uppercase tracking-widest mb-4 italic">Filtros Inteligentes</h3>
                                ...
                                <button
                                    ...
                                    className={cn(
                                        ...
                                        datePeriod === p.id 
                                            ...
                                            : "glass border-foreground/10 text-foreground/40 hover:text-foreground"
                                    )}
                                >
                                    {p.label}
                                </button>
                                ...
                                <button
                                    ...
                                    className={cn(
                                        ...
                                        statusFilter === filter.id 
                                            ? "bg-foreground/10 border-foreground/20 text-foreground shadow-lg" 
                    ...
                    <div className="pt-4 border-t border-foreground/5">
                        <div className="relative">
                            ...
                            <input 
                                ...
                                className="w-full pl-9 pr-4 py-2 bg-foreground/5 border border-foreground/10 rounded-xl focus:border-primary/50 text-xs text-foreground"
                            />
                        </div>
                    </div>
                </div>
        ...
        <div className="lg:col-span-9 space-y-6">
          ...
          {(datePeriod === 'TODAY' || datePeriod === 'CUSTOM') && (
          ...
          {isLoading ? (
            ...
            <div className="glass rounded-3xl p-12 border border-foreground/10 flex flex-col items-center justify-center text-center animate-in fade-in zoom-in-95 duration-500">
              ...
              <p className="text-foreground/50 max-w-md text-sm font-medium">
                ...
                {sortedAppointments.map((apt) => (
                  ...
                  >
                      <div className="flex items-center gap-4">
                          ...
                          <div>
                              ...
                              <div className="flex flex-wrap gap-x-4 gap-y-1 mt-2">
                                  <span className="text-xs text-foreground/50 flex items-center gap-1 font-medium">
                      ...
                      <div className="hidden sm:flex flex-col items-end gap-1">
                          <span className="text-[10px] font-black text-foreground/20 uppercase tracking-widest">Servicio</span>
                          <span className="text-xs font-bold text-foreground/60">Ver Detalles</span>
                      </div>
                  </div>
                ))}
              </div>
